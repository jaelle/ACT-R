...
(written-for-act-r-version "7.1" "adaptive-noise extension")

(defstruct adaptive-noise-module act uan bll blc ans ol act-scale)
...
(defun only-permanent-noise (chunk)
  (let ((noise (chunk-permanent-noise chunk)))
    (when (dm-act-level (adaptive-noise-module-act (get-module adaptive-noise)) 'medium)
...
(define-module-fct 'adaptive-noise nil
  ...
  :creation (lambda (x) (declare (ignore x)) (make-adaptive-noise-module))
  ...
  :reset (lambda (mod) (setf (adaptive-noise-module-uan mod) nil))
  )
